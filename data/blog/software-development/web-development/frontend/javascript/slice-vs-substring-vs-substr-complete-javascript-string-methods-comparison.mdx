...
// For substring(20): startIndex=10, endIndex omitted → defaults to 10
// Result: str.substring(10, 10) → "" (empty string)
// Comparison with slice():
...
// Step-by-step:
// 1. startIndex = 20 → clamped to 10
// 2. endIndex = 5
// 3. Check: 10 > 5? YES → SWAP arguments
// 4. Now: startIndex = 5, endIndex = 10
// 5. Extract: indices 5-9 → "Script"
